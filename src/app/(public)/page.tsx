...
export default function Page() {
    ...
    const skills = [
        {
            label: "NextJS",
            className:
                "bg-gradient-to-r from-violet-600 to-pink-400 font-medium",
        },
        {
            label: "ReactJS",
        },
    ...
    return (
        <div className="flex flex-col w-full h-full">
            <div className="bg-background-primary min-h-screen text-white justify-around items-center flex flex-col lg:flex-row w-full shadow gap-8 lg:gap-4 py-20">
                <div className="flex flex-col gap-8 max-w-lg ">
                    ...
                    <p className="text-zinc-400 text-sm">
                        Eu sou um desenvolvedor Full Stack Web, com foco em
                        ReactJS e NodeJS.
                    </p>
            ...
            <div
                className="bg-background-secondary min-h-screen text-white justify-around items-center flex flex-col lg:flex-row w-full shadow gap-8 lg:gap-4 py-20"
                ref={refServices}
            >
                ...
                <div className="flex flex-col gap-8 max-w-lg ">
                    ...
                    <p className="text-zinc-400 text-sm leading-7">
                        Olá, meu nome é Guilherme Cardilho, sou desenvolvedor
                        web Full Stack, com foco em ReactJS e NodeJS a 2 anos e
                        sou apaixonado por tecnologia e inovação, por isso
                        sempre estou buscando novos conhecimentos e desafios.
                    </p>
                    ...
                    <div className="flex gap-4 flex-col">
                        ...
                        <div className="flex flex-1 flex-wrap gap-2">
                            {skills.map((skill, index) => (
                                <div
                                    key={index}
                                    className={`flex px-2 py-1 bg-zinc-600 rounded-sm ${
                                        skill.className || ""
                                    }`}
                                >
                                    {skill.label}
                ...
                <div className="flex flex-col gap-10 px-20">
                    ...
                    <div className="flex gap-6 flex-wrap ">
                        {services.map((service, index) => (
                            <div
                                className={clsx(
                                    "flex flex-col flex-1 cursor-pointer bg-zinc-800 p-4 rounded-md shadow gap-4  min-w-[300px] hover:shadow-violet-700 transition-all  hover:scale-105 hover:bg-gradient-to-t hover:from-violet-600 hover:via-violet-400 hover:to-pink-400 !text-white ",
                                    {
                                        "bg-gradient-to-r from-violet-600 to-pink-400":
                                            servicesOnHover === index ||
                                            servicesClicked.includes(index),
                                    }
                                )}
                                key={index}
                                onMouseEnter={() => {
                            ...
                            >
                                ...
                                <p
                                    className={clsx(
                                        "text-sm text-zinc-300 leading-6 justify-center items-center flex ",
                                        {
                                            "!text-white":
                                                servicesOnHover === index ||
                                                servicesClicked.includes(index),
